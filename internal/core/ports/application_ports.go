...
type ProjectCreator interface {
	Create(def domain.ProjectDefinition, envVars domain.EnvVars, opts domain.ProjectCreateOptions) (*domain.Project, error)
}
...
type ProjectInputService interface {
	...
	MergeInputs(cfg *domain.ConfigInput, flags domain.ProjectConfigFlags) (domain.ProjectDefinition, domain.EnvVars, error)
